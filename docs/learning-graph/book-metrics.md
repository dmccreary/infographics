...
| 6 | Chapter References | 1 / 14 | Recommended | Chapters with references.md (10 references total) |
| 7 | Glossary Terms | 350 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 72 | Recommended | Questions in faq.md |
| 9 | Words | 180,360 | Required | Words across student-facing markdown |
| 10 | Mascot | 9 | Optional | Mascot image poses in docs/img/mascot/ |
...
|-------------|-------------|---------------|-------|
| Diagrams | 74 | 74 | H4 headers starting with '#### Diagram:' |
| Equations | 49 | 3 | LaTeX expressions (inline and display) |
| Total Words | 180,360 | 97,894 | Words in markdown files |
| Links | 646 | 146 | Hyperlinks in markdown format |
| Equivalent Pages | 780 | 450 | Estimated pages (250 words/page + visuals) |
