# Learning Graph for Interactive Infographics for Intelligent Textbooks
...
- Connectivity: all 350 nodes connected in a single component
...
- Category organization - foundational elements first, advanced visualizations last
- Balanced categories (3.1% - 18.3% each)
