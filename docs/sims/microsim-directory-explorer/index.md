---
title: MicroSim Directory Structure Explorer
description: Interactive p5.js MicroSim for microsim directory structure explorer.
...
[Run the MicroSim Directory Structure Explorer MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/infographics/sims/microsim-directory-explorer/main.html"
        height="452px"
        width="100%"
        scrolling="no"></iframe>
```
