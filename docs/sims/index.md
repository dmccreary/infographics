---
title: List of MicroSims for Interactive Infographics
description: A list of all the MicroSims used in the Interactive Infographics course
hide:
    - toc
---
...
-   **[Accessibility Audit Checklist](./accessibility-audit-checklist/index.md)**
...
-   **[Advanced Interaction Pattern Showcase](./advanced-interaction-showcase/index.md)**
...
-   **[AI Image Generation Prompt Builder](./ai-image-prompt-builder/index.md)**
...
-   **[AI Quality Review Dashboard](./ai-quality-review-dashboard/index.md)**
...
-   **[AI-Assisted Workflow Evolution Timeline](./ai-workflow-evolution/index.md)**
...
-   **[Animal Cell Explorer](./animal-cell/index.md)**

    ![Animal Cell Explorer](./animal-cell/animal-cell.png)
...
-   **[Audience Adaptation Comparison](./audience-adaptation-comparison/index.md)**

    ![Audience Adaptation Comparison](./audience-adaptation-comparison/audience-adaptation-comparison.png)
...
-   **[Bloom's Taxonomy MicroSim Matcher](./blooms-microsim-matcher/index.md)**
...
-   **[Chart Type Gallery](./chart-type-gallery/index.md)**

    ![Chart Type Gallery](./chart-type-gallery/chart-type-gallery.png)
...
-   **[Chart Type Selection Guide](./chart-type-selector/index.md)**

    ![Chart Type Selection Guide](./chart-type-selector/chart-type-selector.png)
...
-   **[CI/CD Deployment Pipeline](./cicd-deployment-pipeline/index.md)**
...
-   **[CLD Building Blocks Explorer](./cld-building-blocks/index.md)**
...
-   **[Cognitive Load Balance Explorer](./cognitive-load-explorer/index.md)**

    ![Cognitive Load Balance Explorer](./cognitive-load-explorer/cognitive-load-explorer.png)
...
-   **[Engagement Metrics Dashboard](./engagement-metrics-dashboard/index.md)**

    Interactive Chart.js dashboard for visualizing engagement metrics across educational content.

-   **[Event Handling Data Flow](./event-handling-flow/index.md)**
...
-   **[Event Logging Flow Visualization](./event-logging-flow/index.md)**

    Interactive visualization of the event logging flow in MicroSim applications.

-   **[Framework Decision Pipeline](./framework-decision-pipeline/index.md)**

    Interactive pipeline for deciding which JavaScript framework to use for a given MicroSim.

-   **[Gestalt Principles Interactive Playground](./gestalt-principles-playground/index.md)**

    ![Gestalt Principles Interactive Playground](./gestalt-principles-playground/gestalt-principles-playground.png)
...
-   **[Hit Detection Playground](./hit-detection-playground/index.md)**

    Interactive playground for experimenting with hit detection techniques in canvas-based MicroSims.

-   **[Iframe Security Model](./iframe-security-model/index.md)**

    Interactive exploration of iframe security features including sandboxing, CSP, and cross-origin policies.

-   **[Infobox Positioning Comparison](./infobox-positioning-comparison/index.md)**

    ![Infobox Positioning Comparison](./infobox-positioning-comparison/infobox-positioning-comparison.png)

    Compare below, side panel, and floating tooltip infobox strategies with hover or click triggers.

-   **[Infographic Design Principles Workflow](./design-principles-workflow/index.md)**

    Interactive workflow showing how design principles are applied throughout the infographic creation process.

-   **[Infographic Development Workflow](./infographic-dev-workflow/index.md)**

    ![Infographic Development Workflow](./infographic-dev-workflow/infographic-dev-workflow.png)

    Interactive visualization of the end-to-end infographic development workflow.

-   **[Infographic Lifecycle Wheel](./infographic-lifecycle-wheel/index.md)**

    ![Infographic Lifecycle Wheel](./infographic-lifecycle-wheel/infographic-lifecycle-wheel.png)

    Interactive wheel showing the phases of an infographic's lifecycle from concept to deployment and iteration.

-   **[Infographic Type Decision Tree](./infographic-type-decision-tree/index.md)**

    ![Infographic Type Decision Tree](./infographic-type-decision-tree/infographic-type-decision-tree.png)

    Interactive decision tree for choosing the right infographic type based on content and audience.

-   **[Interaction Feedback Patterns Demo](./interaction-feedback-demo/index.md)**

    ![Interaction Feedback Patterns Demo](./interaction-feedback-demo/interaction-feedback-demo.png)

    Interactive demonstration of feedback patterns including hover effects, click responses, and drag interactions.

-   **[Interactive CLD Builder](./cld-builder/index.md)**
...
-   **[Interactive Cycle Builder](./interactive-cycle-builder/index.md)**

    ![Interactive Cycle Builder](./interactive-cycle-builder/interactive-cycle-builder.png)

    Build and explore cyclical process diagrams by adding stages and defining relationships between them.

-   **[Interactive Infographic Taxonomy Tree](./infographic-taxonomy-tree/index.md)**

    ![Interactive Infographic Taxonomy Tree](./infographic-taxonomy-tree/infographic-taxonomy-tree.png)
...
-   **[Interactive Learning Graph Explorer](./learning-graph-explorer/index.md)**

    ![Interactive Learning Graph Explorer](./learning-graph-explorer/learning-graph-explorer.png)

    Interactive vis-network explorer for navigating the course learning graph.

-   **[JavaScript Modern Syntax Playground](./js-syntax-playground/index.md)**

    ![JavaScript Modern Syntax Playground](./js-syntax-playground/js-syntax-playground.png)
...
-   **[Knowledge Graph Learning Path Explorer](./learning-path-explorer/index.md)**

    ![Knowledge Graph Learning Path Explorer](./learning-path-explorer/learning-path-explorer.png)
...
-   **[Leverage Point and Unintended Consequence Explorer](./leverage-point-explorer/index.md)**

    ![Leverage Point and Unintended Consequence Explorer](./leverage-point-explorer/leverage-point-explorer.png)

    Interactive exploration of system leverage points and their potential unintended consequences.

-   **[Library Selection Flowchart](./library-selection-flowchart/index.md)**

    ![Library Selection Flowchart](./library-selection-flowchart/library-selection-flowchart.png)

    Interactive flowchart for selecting the right JavaScript visualization library for a given MicroSim.

-   **[Mayer's Principles Interactive Comparison](./mayers-principles-comparison/index.md)**

    Apply Mayer's signaling, segmenting, and spatial contiguity principles by toggling each on and off in a sample infographic.

-   **[MicroSim Architecture Overview](./microsim-architecture-overview/index.md)**

    ![MicroSim Architecture Overview](./microsim-architecture-overview/microsim-architecture-overview.png)

    Interactive diagram showing the four-file MicroSim directory structure and how each file serves a distinct role.

-   **[MicroSim Directory Structure Explorer](./microsim-directory-explorer/index.md)**

    ![MicroSim Directory Structure Explorer](./microsim-directory-explorer/microsim-directory-explorer.png)

    Interactive explorer of the standard MicroSim directory structure and file organization.

-   **[MicroSim Quality Scorer](./microsim-quality-scorer/index.md)**

    ![MicroSim Quality Scorer](./microsim-quality-scorer/microsim-quality-scorer.png)
...
-   **[MicroSim Visual Standards Explorer](./microsim-visual-standards/index.md)**

    ![MicroSim Visual Standards Explorer](./microsim-visual-standards/microsim-visual-standards.png)

    Interactive explorer of visual design standards for consistent MicroSim presentation.

-   **[Multi-Dimensional Classification Explorer](./multi-dimensional-classifier/index.md)**

    ![Multi-Dimensional Classification Explorer](./multi-dimensional-classifier/multi-dimensional-classifier.png)
...
-   **[Overlay Type Comparison](./overlay-type-comparison/index.md)**
...
-   **[Process Diagram Variants](./process-diagram-variants/index.md)**

    ![Process Diagram Variants](./process-diagram-variants/process-diagram-variants.png)
...
-   **[Purpose Classification Sorter](./purpose-classification-sorter/index.md)**

    ![Purpose Classification Sorter](./purpose-classification-sorter/purpose-classification-sorter.png)
...
-   **[Relationship Diagram Explorer](./relationship-diagram-explorer/index.md)**

    ![Relationship Diagram Explorer](./relationship-diagram-explorer/relationship-diagram-explorer.png)

    Interactive explorer of different relationship diagram types and their visual representations.

-   **[Responsive Layout Simulator](./responsive-layout-sim/index.md)**
...
-   **[School District Infographic Adoption CLD](./school-district-cld/index.md)**

    ![School District Infographic Adoption CLD](./school-district-cld/school-district-cld.png)

    Interactive causal loop diagram modeling the dynamics of infographic adoption in a school district.

-   **[Six Frameworks Interactive Gallery](./six-frameworks-gallery/index.md)**

    ![Six Frameworks Interactive Gallery](./six-frameworks-gallery/six-frameworks-gallery.png)

    Interactive gallery exploring six foundational frameworks for visual communication and infographic design.

-   **[Six W's Visual Matcher](./six-ws-visual-matcher/index.md)**

    ![Six W's Visual Matcher](./six-ws-visual-matcher/six-ws-visual-matcher.png)

    Interactive matching exercise connecting the six W's of infographic planning to their visual representations.

-   **[SmartArt Category Gallery](./smartart-category-gallery/index.md)**
...
-   **[SmartArt Category Matching Quiz](./smartart-category-quiz/index.md)**

    ![SmartArt Category Matching Quiz](./smartart-category-quiz/smartart-category-quiz.png)

    Interactive quiz for matching SmartArt categories to their appropriate use cases.

-   **[SQVID Style Selector](./sqvid-style-selector/index.md)**
...
-   **[Structural Format Gallery](./structural-format-gallery/index.md)**

    ![Structural Format Gallery](./structural-format-gallery/structural-format-gallery.png)
...
-   **[Type 1 Rectangular Overlay Demo](./type1-rectangular-overlay/index.md)**

    ![Type 1 Rectangular Overlay Demo](./type1-rectangular-overlay/type1-rectangular-overlay.png)

    Interactive demonstration of rectangular overlay regions with hover callouts and click interactions.

-   **[Type 2 Polygon Overlay Demo](./type2-polygon-overlay/index.md)**

    ![Type 2 Polygon Overlay Demo](./type2-polygon-overlay/type2-polygon-overlay.png)

    Interactive demonstration of polygon-shaped overlay regions for complex image annotations.

-   **[Type 3 Callout to Edge Demo](./type3-callout-overlay/index.md)**

    ![Type 3 Callout to Edge Demo](./type3-callout-overlay/type3-callout-overlay.png)

    Interactive demonstration of callout lines connecting labels to specific diagram features.

-   **[Type 4 Floating Label with Edit Mode Demo](./type4-floating-overlay/index.md)**

    ![Type 4 Floating Label with Edit Mode Demo](./type4-floating-overlay/type4-floating-overlay.png)

    Interactive demonstration of floating labels with an edit mode for repositioning annotations.

-   **[Virtuous and Vicious Cycle Examples](./virtuous-vicious-cycles/index.md)**

    ![Virtuous and Vicious Cycle Examples](./virtuous-vicious-cycles/virtuous-vicious-cycles.png)

    Interactive examples of virtuous and vicious feedback cycles in real-world systems.

-   **[Visual Encoding Channel Explorer](./visual-encoding-explorer/index.md)**
...
-   **[Visual Framework Matching Quiz](./visual-framework-quiz/index.md)**

    ![Visual Framework Matching Quiz](./visual-framework-quiz/visual-framework-quiz.png)

    Interactive quiz for matching visual frameworks to their definitions and use cases.

-   **[Web Fundamentals Architecture Overview](./web-fundamentals-architecture/index.md)**

    ![Web Fundamentals Architecture Overview](./web-fundamentals-architecture/web-fundamentals-architecture.png)
